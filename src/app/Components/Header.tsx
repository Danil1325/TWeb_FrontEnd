                ...
                <div className="relative flex h-16 items-center justify-between">
                    <div className="flex flex-1 items-center justify-start">
                        <div className="flex shrink-0 items-center">
                            <img src={logo} alt="PharmaWarehouse logo" className="h-17 w-17 object-contain" />
                        ...
                        <div className="flex space-x-4">
                            {navigation.map((item) => (
                                <Link
                                    key={item.name}
                                    to={item.href}
                                    className={classNames('rounded-md px-3 py-2 text-sm font-medium text-white')}
                                >
                                    {item.name}
                                </Link>
                            ))}
